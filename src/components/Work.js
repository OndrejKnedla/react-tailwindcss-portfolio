        ...
        <div className="flex flex-col lg:flex-row gap-x-10 lg:mt-16">
          ...
          >
            ...
            <div className="">
              ...
              <button className="btn btn-sm">Podívat se na všechny projekty.</button>
            </div>
            ...
            <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl ">
              ...
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                <span className="text-3xl text-white">Titulek</span>
              </div>
            </div>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl ">
              ...
              {/* subtitle */}
              <div className="absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50">
                <span className="text-gradient">Moderní Website</span>
              </div>
              {/* title */}
              <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                <span className="text-3xl text-white">Titulek</span>
